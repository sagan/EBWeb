...
exports.fromKana = function(str) {
  ...
  str = str.replace(/[NM]'([BCDFGHJKLMNPQRSTVWXZ]|$)/g, "N$1");
...
exports.toHiragana = function(str) {
  ...
  // original: AEIOUN
  // Array.from("ABCDEFGHIJKLMNOPQRSTUVWXYZ").filter(a => !"AEIOUN".includes(a)).join("")
...
exports.toKatakana = function(str) {
  ...
  str = str.replace(/([BCDFGHJKLMPQRSTVWXYZ])\1/g, "ッ$1");
...
exports.cleanRomaji = function(str) {
  ...
  str = str.replace(/(\w)M([BCDFGHJKLNPQRSTVWXZ]|$)/g, "$1N$2");
  ...
  str = str.replace(/OH([BCDFGHJKLMNPQRSTUVWXYZ]|$)/g, "OO$1");
